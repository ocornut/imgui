...
- You may find a precompiled version binary_to_compressed_c.exe for Windows inside of the demo binaries package (see [README](https://github.com/ocornut/imgui/blob/master/docs/README.md)).
