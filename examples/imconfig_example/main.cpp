...
int main(int, char**)
{
    ...
    MyVec4 clear_color = (ImVec4)ImColor(114, 144, 154);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            ImGui::SetNextWindowSize(MyVec2(200,100), ImGuiSetCond_FirstUseEver);
        ...
        if (show_test_window)
        {
            ImGui::SetNextWindowPos(MyVec2(650, 20), ImGuiSetCond_FirstUseEver);
