...
static void draw() {
    ...
    ImGui_ImplGL_RenderDrawData(ImGui::GetDrawData());
...
#elif defined(IMGUI_IMPL_OPENGL_4)
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, 4);
    SDL_GL_SetAttribute(SDL_GL_CONTEXT_MINOR_VERSION, 1);
#endif
#elif defined(IMGUI_IMPL_OPENGL_EMBEDDED)
...
#error "Unsupported GL version"
    ...
    g_window = SDL_CreateWindow("Dear ImGui SDL2+GL", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 960, 640,
                                window_flags);
