...
if (_OPTIONS["with-dx11"]) then
	project "example_win32_directx11"
		...
		imgui_as_src ("..", "imgui")
		--imgui_as_lib ("..")
		files { "imgui_impl_win32.*", "imgui_impl_dx11.*", "example_win32_directx11/*.cpp", "example_win32_directx11/*.h", "README.txt" }
        vpaths { ["sources"] = "./**" }
...
if (_OPTIONS["with-dx9"]) then
	project "example_win32_directx9"
		...
		imgui_as_src ("..", "imgui")
		--imgui_as_lib ("..")
		files { "imgui_impl_win32.*", "imgui_impl_dx9.*", "example_win32_directx9/*.cpp", "example_win32_directx9/*.h", "README.txt" }
        vpaths { ["sources"] = "./**" }
		filter { "system:windows" }
			links { "d3d9" }
end
...
if (_OPTIONS["with-dx10"]) then
	project "example_win32_directx10"
		...
		imgui_as_src ("..", "imgui")
		--imgui_as_lib ("..")
		files { "imgui_impl_win32.*", "imgui_impl_dx10.*", "example_win32_directx10/*.cpp", "example_win32_directx10/*.h", "README.txt" }
        vpaths { ["sources"] = "./**" }
		filter { "system:windows", "toolset:msc-v80 or msc-v90 or msc-v100" }
			includedirs { "$(DXSDK_DIR)/Include" }
		filter { "system:windows", "toolset:msc-v80 or msc-v90 or msc-v100", "platforms:x86" }
...
if (_OPTIONS["with-dx12"]) then
	project "example_win32_directx12"
		...
		imgui_as_src ("..", "imgui")
		--imgui_as_lib ("..")
		files { "imgui_impl_win32.*", "imgui_impl_dx12.*", "example_win32_directx12/*.cpp", "example_win32_directx12/*.h", "README.txt" }
        vpaths { ["sources"] = "./**" }
		filter { "system:windows" }
...
if (_OPTIONS["with-glfw"]) then
	project "example_glfw_opengl2"
		...
		imgui_as_src ("..", "imgui")
		--imgui_as_lib ("..")
		files { "imgui_impl_glfw.*", "imgui_impl_opengl2.*", "example_glfw_opengl2/*.h", "example_glfw_opengl2/*.cpp", "README.txt"}
        vpaths { ["sources"] = "./**" }
...
if (_OPTIONS["with-glfw"]) then
	project "example_glfw_opengl3"
		...
		--imgui_as_lib ("..")
        vpaths { ["sources"] = "./**" }
		files { "imgui_impl_glfw.*", "imgui_impl_opengl3.*", "example_glfw_opengl3/*.h", "example_glfw_opengl3/*.cpp", "./README.txt", "libs/gl3w/GL/gl3w.c" }
...
if (_OPTIONS["with-vulkan"]) then
    project "example_glfw_vulkan"
        ...
        --imgui_as_lib ("..")
        vpaths { ["sources"] = "./**" }
        files { "imgui_impl_glfw*", "imgui_impl_vulkan.*", "example_glfw_vulkan/*.h", "example_glfw_vulkan/*.cpp", "./README.txt" }
