...
int main(int, char**)
{
...
#endif
    {
        ...
        if (!ImGui_ImplWGPU_CheckSurfaceTextureOptimalStatus(surface_texture.status))
        {
...
#ifndef NDEBUG
    ImGui_ImplWGPU_PrintAdapterInfo(acquired_adapter.Get());
#endif
...
#ifndef NDEBUG
    ImGui_ImplWGPU_PrintAdapterInfo(local_adapter);
#endif
