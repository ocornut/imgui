...
void ImGui_ImplGlfw_RenderDrawLists(ImDrawData* draw_data)
{
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        glVertexPointer(2, GL_FLOAT, sizeof(ImDrawVert), ((char const*)vtx_buffer + OFFSETOF(ImDrawVert, pos)));
        glTexCoordPointer(2, GL_FLOAT, sizeof(ImDrawVert), ((char const*)vtx_buffer + OFFSETOF(ImDrawVert, uv)));
        glColorPointer(4, GL_UNSIGNED_BYTE, sizeof(ImDrawVert), ((char const*)vtx_buffer + OFFSETOF(ImDrawVert, col)));
