// dear imgui: standalone example application for SFML + OpenGL2, using legacy fixed pipeline
// If you are new to dear imgui, see examples/README.txt and documentation at the top of imgui.cpp.
// (SFML is a cross-platform general purpose library for handling windows, inputs, OpenGL graphics context creation, etc.)
#include "imgui.h"
