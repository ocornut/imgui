...
namespace ImGui
{
    ...
    IMGUI_API void          ShadeVertsLinearAlphaGradientForLeftToRightText(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, float gradient_p0_x, float gradient_p1_x);
