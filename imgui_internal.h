...
struct ImGuiContext
{
    ...
    ImVec2                  MovingWindowClickOffset;            // Click offset used to position MovingWindow. May be rebased when a platform window manager adjusts our requested position.
