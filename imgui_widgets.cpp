...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    IM_ASSERT(ImIsPowerOfTwo((int)(flags & ImGuiColorEditFlags__DisplayMask))); // Check that only 1 is selected
    ...
    if ((flags & ImGuiColorEditFlags_InputHSV) && !(flags & ImGuiColorEditFlags_DisplayHSV))
