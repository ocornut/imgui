...
struct ZhCNRegistrar {
    ZhCNRegistrar() {
        imgui_i18n::registerLocale("zh_CN", {
            ...
            {"dear imgui says hello! (%s) (%d)", "亲爱的 imgui 向你问好！(%s) (%d)"},
            ...
            // === main.mm window ===
            {"Hello, world!", "你好，世界！"},
            {"This is some useful text.", "这是一段有用的文字。"},
            {"Demo Window", "演示窗口"},
            ...
            {"Button", "按钮"},
            {"counter = %d", "计数器 = %d"},
            {"Application average %.3f ms/frame (%.1f FPS)", "应用程序平均 %.3f 毫秒/帧（%.1f FPS）"},
