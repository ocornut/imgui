...
//   and want to clear another flag, you need to pass in the ImGuiPopupFlags_MouseButtonRight flag.
...
enum ImGuiKey_
{
    ...
    // [Internal] Prior to 1.87 we required user to fill io.KeysDown[512] using their own native index + an io.KeyMap[] array.
