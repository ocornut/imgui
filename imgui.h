...
typedef int ImGuiTextAlignment;     // enum: text alignment						// enum ImGuiTextAlignment_
...
namespace ImGui
{
    ...
    // Widgets: Text
	IMGUI_API void          SetTextAlignment(ImGuiTextAlignment alignment = 0);
...
// 
enum ImGuiTextAlignment_
{
	ImGuiTextAlignment_Left,
	ImGuiTextAlignment_Center,
	ImGuiTextAlignment_Right
};
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL, ImGuiTextAlignment alignment = ImGuiTextAlignment_Left);
...
struct ImFont
{
    ...
    IMGUI_API void              RenderText(ImDrawList* draw_list, float size, ImVec2 pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false, ImGuiTextAlignment alignment = ImGuiTextAlignment_Left) const;
	IMGUI_API void              RenderTextLine(ImDrawList* draw_list, float scale, float size, ImVec2 pos, ImU32 col, const ImVec4& clip_rect, const char* line, const char* text_end, float wrap_width, bool cpu_fine_clip, ImGuiTextAlignment alignment = ImGuiTextAlignment_Left) const;
