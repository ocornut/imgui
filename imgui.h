...
namespace ImGui
{
	...
	IMGUI_API int			Bezier(const char *label, float P[4]);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_DisableModalDimming    = 1 << 17,  // Prevent a modal window from dimming the background (interferes with editing colours)
