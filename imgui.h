...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool using_label = true);
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_NoName              = 1 << 21   // No name display
...
enum ImGuiComboFlags_
{
    ...
    ImGuiComboFlags_NoName                  = 1 << 8,   // Display without label
