...
namespace ImGui
{
    ...
    IMGUI_API bool          IsItemDoubleClicked(ImGuiMouseButton mouse_button = 0);             // is the last item hovered and mouse double-clicked on? (**)  == IsMouseDoubleClicked(mouse_button) && IsItemHovered()Important. (**) this it NOT equivalent to the behavior of e.g. Button(). Read comments in function definition.
