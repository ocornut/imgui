...
namespace ImGui
{
    ...
    IMGUI_API bool          IsMouseTripleClicked(ImGuiMouseButton button);                      // did mouse button triple-clicked? a triple-click returns false in IsMouseClicked() and IsMouseDoubleClicked(). uses io.MouseTripleClickTime.
