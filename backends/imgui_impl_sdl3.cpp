...
//  2024-09-11: Added support for parent viewports.
...
struct ImGui_ImplSDL3_ViewportData
{
    ...
    ImGui_ImplSDL3_ViewportData() { Window = Parent = nullptr; WindowID = 0; WindowOwned = false; GLContext = nullptr; }
...
static void ImGui_ImplSDL3_CreateWindow(ImGuiViewport* viewport)
{
    ...
    vd->Parent = ImGui_ImplSDL3_GetSDLWindowFromViewportID(viewport->ParentViewportId);
    ...
    SDL_SetWindowParent(vd->Window, vd->Parent);
...
static void ImGui_ImplSDL3_UpdateWindow(ImGuiViewport* viewport)
{
    ...
    if (new_parent != vd->Parent)
    {
        vd->Parent = new_parent;
        SDL_SetWindowParent(vd->Window, vd->Parent);
    }
}
